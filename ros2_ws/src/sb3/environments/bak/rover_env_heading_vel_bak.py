...
class RoverEnv(gym.Env):
    ...
    def heading_controllerOld(self, desired_heading, current_heading):
    ...
    def task_reward(self):
        ...
        if heading_diff < math.pi/2:
            ...
            reward = 0.0  # No reward when facing wrong direction
        ...
        # Debug logging
        if self.total_steps % 1000 == 0:
            print(f"Distance: {current_distance:.2f}, Heading diff: {math.degrees(heading_diff):.1f}°")
    ...
    def task_reward_Old(self):
        ...
        distance_scaling_factor = 10.0  # Reduced from 20
